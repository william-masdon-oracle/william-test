...
- OAuth client_id/client_secret for the ORDS token endpoint.

## Environment variables
Set these before running:

```bash
export CLIENT_ID='9VOD22C3mjb7SrrceqF10g..'
export CLIENT_SECRET='YwtXRCoGxl_jF_CMfXHUww..'
# Optional:
# export SCOPE='...'
...
If you want a per-request log, set LOG_SAMPLE_RATE and redirect stdout to a file.
Example (log all requests):

```bash
LOG_SAMPLE_RATE=1 k6 run loadtest.js > results.jsonl
```
